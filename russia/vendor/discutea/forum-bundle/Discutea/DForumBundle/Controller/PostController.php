...
class PostController extends BasePostController
{
    ...
    public function postAction(Request $request, Topic $topic)
    {
        ...
        $categories = $this->getEm()->getRepository(Topic::class)->findAllByForumOrderedByDate($topic->getForum());
      //bech nkamelha ki nzid les champs


        $lasttopic=$this->getEm()->getRepository(Topic::class)->findLast(4);
